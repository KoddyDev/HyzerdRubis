...
class SetCommand : CommandManager("set") {

    init {
        usage = "/rubis admin set <player> <quantia>"
    ...
    override fun playerCommand(player: Player, args: Array<String>) {
        ...
        target.rubis.setRubis(quantia.toInt())
        player.sendMessage("§aVocê setou §5${quantia.toInt().format(true)} rubis §apara o jogador §f${args[0]}")
